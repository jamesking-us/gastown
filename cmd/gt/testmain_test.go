...
//
// This package's test binary links the whole gt command tree, so it reaches the beads SDK, the rig manager and the Dolt client. Without isolation such a test inherits the
