...
//
// Doctor checks read the town's real HOME-rooted state and reach the beads SDK, the rig manager and the Dolt client; doctor.test was one of the binaries observed running during the ~/.beads-planning writes in cl-69h. Without isolation such a test inherits the
